...
class RecipeTest < ActionController::TestCase
  ...
  test "can create a new recipe" do
    recipe = Recipe.new("Amazing Cupcakes", 'https://www.edamam.com/web-img/9d6/9d6dde186b5b082461f5c6038c51604b.jpg', 'http://www.101cookbooks.com/archives/000132.html', 'http://www.edamam.com/ontologies/edamam.owl%23recipe_4a97965157df17841696bbbcc8a27935')
    assert(recipe.is_a?(Recipe))
  end

  test "Must have a label, image, uri, and url for a new recipe" do
    assert_raises ArgumentError do
      Recipe.new nil, nil, nil, nil
    end
    assert_raises ArgumentError do
      Recipe.new "", "", "", ""
    end
    assert_raises ArgumentError do
      Recipe.new "slack-api-test", "", "", ""
    end
    assert_raises ArgumentError do
      Recipe.new "slack-api-test", nil, nil, nil
    end
  end

  test "label attribute is set correctly" do
    recipe = Recipe.new("label", "uri",  "url",  "image")
    assert_not_nil(recipe.label)
    assert_equal(recipe.label, "label")
  end

  test 'uri attribute is set correctly' do
    recipe = Recipe.new("label", "image", "http://www.edamam.com/ontologies/edamam.owl%23recipe_4a97965157df17841696bbbcc8a27935", "url")
  ...
  test 'url attribute is set correctly' do
    recipe = Recipe.new("label", "image", "uri", "http://www.101cookbooks.com/archives/000132.html")
  ...
  test 'new recipe has an image' do
    recipe = Recipe.new("label", "https://www.edamam.com/web-img/9d6/9d6dde186b5b082461f5c6038c51604b.jpg", "url",  'uri')
