...
## Reflection
I obviously understand APIs better after doing this project, but I also feel like it made me delve into testing a lot more. Without a model it seemed impossible to test all of the data after the data is pulled from the API and manipulated in the controller, but I found that you can access controller params and variables by just putting @controller in a test, and you can access all the information associated with the view in a current state with @response. 

I would love more time working on APIs, which we're getting!

I am probably too apprehensive to use gems for full features, but I think the paginate gem would have saved me a lot of time. I should probably work on using those more.
